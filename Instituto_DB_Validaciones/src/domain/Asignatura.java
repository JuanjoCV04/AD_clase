...
public class Asignatura {
	...
	public Asignatura(String cod_asignatura) {
		this.cod_asignatura = cod_asignatura;
	}

	public Asignatura(String cod_asignatura, String cod_interno, String descripcion, int nHoras, String cod_curso) {
		super();
		this.cod_asignatura = cod_asignatura;
	...
	public String toString() {
		return "Asignatura [cod_asignatura=" + cod_asignatura + ", cod_interno=" + cod_interno + ", descripcion="
				+ descripcion + ", nHoras=" + nHoras + ", cod_curso=" + cod_curso + "]";
	}
