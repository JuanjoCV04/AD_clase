...
public class Alumno {
	...
	public Alumno(String nre) {
		this.nre = nre;
	}

	public Alumno(String nre, String dni, String nombre, String apellido1, String apellido2, String tipo_via,
	...
	public String toString() {
		return "Alumno [nre=" + nre + ", dni=" + dni + ", nombre=" + nombre + ", apllido1=" + apellido1 + ", apellido2="
				+ apellido2 + ", tipo_via=" + tipo_via + ", nombre_via=" + nombre_via + ", numero=" + numero
